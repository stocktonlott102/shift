    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 dark:from-neutral-900 dark:to-neutral-800">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-2xl mx-auto bg-white dark:bg-neutral-800 rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold mb-6 text-neutral-900 dark:text-white">New Lesson Type</h1>
          {error && <div className="mb-4 text-error-600 dark:text-error-400">{error}</div>}
